...
public class LoginMapReduce extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setJarByClass(LoginMapReduce.class);
        // 配置MapReduce程序
        job.setMapperClass(com.zlikun.learning.logins.hbase.LoginMapper.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("/output/12"));
