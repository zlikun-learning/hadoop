...
public class StringPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3814883719618944856L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StringPair\",\"namespace\":\"com.zlikun.learning.avro\",\"doc\":\"A pair of strings.\",\"fields\":[{\"name\":\"left\",\"type\":\"string\"},{\"name\":\"right\",\"type\":\"string\"}]}");
   ...
   */
  public static com.zlikun.learning.avro.StringPair.Builder newBuilder() {
    return new com.zlikun.learning.avro.StringPair.Builder();
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static com.zlikun.learning.avro.StringPair.Builder newBuilder(com.zlikun.learning.avro.StringPair.Builder other) {
    return new com.zlikun.learning.avro.StringPair.Builder(other);
  }
   ...
   * @return A new StringPair RecordBuilder
   */
  public static com.zlikun.learning.avro.StringPair.Builder newBuilder(com.zlikun.learning.avro.StringPair other) {
    return new com.zlikun.learning.avro.StringPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringPair>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.zlikun.learning.avro.StringPair.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.zlikun.learning.avro.StringPair other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.left)) {
        this.left = data().deepCopy(fields()[0].schema(), other.left);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zlikun.learning.avro.StringPair.Builder setLeft(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zlikun.learning.avro.StringPair.Builder clearLeft() {
      left = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zlikun.learning.avro.StringPair.Builder setRight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zlikun.learning.avro.StringPair.Builder clearRight() {
      right = null;
